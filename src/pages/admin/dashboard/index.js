      ...
      <Page title="Dashboard">
        <Layout>
          <Layout.Section oneThird>
            <Card title="Total Products" actions={[{ content: "View" }]}>
              <Card.Section>
                <TextStyle variation="subdued">1M units available</TextStyle>
              </Card.Section>
          ...
          <Layout.Section oneThird>
            <Card title="Best Seller" actions={[{ content: "View" }]}>
              <Card.Section>
          ...
          <Layout.Section oneThird>
            <Card title="Top Suppliers" actions={[{ content: "Manage" }]}>
              <Card.Section>
